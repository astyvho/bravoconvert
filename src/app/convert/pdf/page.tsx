    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <article className="mx-auto mt-8 max-w-4xl space-y-10 rounded-3xl border border-gray-200 bg-white p-6 text-gray-700 shadow-sm md:p-10">
          <header>
            <h2 className="text-3xl font-bold text-black">A practical guide to converting PDF pages into images</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">Choose JPG or PNG for the page content</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">How page rendering works</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">Privacy and browser resource use</h2>
            <p className="mt-3 leading-7">
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">Supported files and practical limits</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">Downloading one page or the full set</h2>
            <p className="mt-3 leading-7">
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">Tips for clearer and smaller output</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6 leading-7">
          ...
          <section>
            <h2 className="text-2xl font-bold text-black">Troubleshooting PDF conversion</h2>
            <p className="mt-3 leading-7">
